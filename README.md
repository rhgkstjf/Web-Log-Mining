...
해킹당한 웹 서버의 로그기록을 웹 로그 마이닝을 통해 관심 있는 사용자들의 유용한 행동 패턴을 추출하고, 유해 봇들을 추출하고 웹 서비스에 활용가능한 정보를 얻기  프로젝트입니다.
...
* [Spark Install](https://github.com/rhgkstjf/Web-Log-Mining/tree/main/spark)


* [ELK Install](https://github.com/rhgkstjf/Web-Log-Mining/tree/main/ELK)
  * Logstash
  * Elasticsearch
  * Kibana
  * Filebeat
...
* [Flask Install](https://github.com/rhgkstjf/Web-Log-Mining/tree/main/Flask)
...
## Raw Apache Web Access Log 전송 방법
...
### 전처리 서버의 시스템 구성
![noname](https://user-images.githubusercontent.com/44472886/103401573-bccd2e00-4b8c-11eb-826c-0ec5ddbb5fbd.png)

전처리 서버의 핵심은 원시 로그 데이터에 들어있는 필드값을 grok 필터를 통해 필트값을 가져오고,   geoip 를 통해서 지리 데이터를 추가하는것입니다.

![noname](https://user-images.githubusercontent.com/44472886/103401675-23eae280-4b8d-11eb-8c7a-a1c1ea0fbdf4.JPG)
...
전처리는 전단계인 원시 로그데이터가 **전송한 후**에 작업이 이루어져야합니다.

<span style="color : red">스케쥴링시에 약간의 시간을 두시고 스케쥴링해주세요.</span>


## 전처리된 데이터를 통해 데이터 분석 방법
...
[[crw.py 소스코드 보러가기]](https://github.com/rhgkstjf/Web-Log-Mining/blob/main/crw.py)
