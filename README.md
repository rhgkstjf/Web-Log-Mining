...
### 교수님의 의뢰로 해킹당한 웹 서버의 로그기록을 웹 로그 마이닝을 통해 관심 있는 사용자들의 유용한 행동 패턴을 추출하고 해킹당한 서버를 위해 유해 봇들을 차단하고 싶어서 시작한 프로젝트입니다.
...
### 프레임워크
### Hadoop Spark ELK Stack

### 개발 언어
### Scala,Python,Shell Script,Javascript
